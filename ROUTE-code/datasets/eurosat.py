...
eurosat_mean = (0.48145466, 0.4578275, 0.40821073)
eurosat_std = (0.26862954, 0.26130258, 0.27577711)
def get_eurosat(cfg):
    resize_dim = 256
    crop_dim = 224
    '''
...
def p_u_split_two_sample(cfg, labels):
    ...
    unlabel_per_class = cfg.num_u // 10 #eurosat
    for i in range(10):
        idx = np.where(labels == i)[0]
