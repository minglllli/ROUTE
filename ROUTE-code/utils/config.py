...
_C.num_epochs = 10
_C.num_iterations_per_epoch = 20
_C.batch_size = 64
...
# PU dataset
_C.dataset = None
_C.root = "/your/root/path"
_C.split_root = "/your/split/root/"
_C.num_p = None
_C.num_u = None
_C.positive_label_list = None
_C.num_classes = None
_C.generation_setting = "one_sample"
_C.classnames = None
_C.p_prior = 0.4 

_C.mu_u = 1 # ratio of batch size of unlabeled data to positive data
